...
function Home() {
  ...
  const [selectValue, setSelectValue] = useState("publications")
	...
	// // if (publicationsIsValidating) return <div className="Loading">Loading...</div>;
			...
			<div className="home-content">
				<section id="hero-img">
					...
					<div className="search">
						<form id="search-form" onSubmit={toggleSearch}>
							<div className="form-group">
								<select name="dropdown" id="select-option" value={selectValue} onChange={handleSelectChange}>
					...
					<div className="content">
						...
						<div className="card-container">
							<Card
								...
								title1="Authors"
								title2="Number of Publications"
								data={getTopContributions(publications)}
							/>
							<Card
								header="Most Cited"
								title1="Title of Paper"
								title2="Number of Citations"
								data={getMostViewedPapers(publications)}
							/>
							<Card
								header="Recently Added"
								title1="Title"
								title2="Date Published"
								data={getRecentDatePublished(publications)}
							/>
						</div>
					...
					<div className="content">
						...
						<div className="card-container">
							<Card
								header="Top Contributor"
								title1="Authors"
								title2="Number of IP Assets"
								data={getTopContributions(ipassets)}
							/>
							<Card
								header="Top Campus with IP Assets"
								title1="Campus"
								title2="Number of IP Assets"
								data={getTopCampus(ipassets)}
							/>
							<Card
								header="Recently Added"
								title1="Title"
								title2="Date Registered"
								data={getRecentDateRegistered(ipassets)}
							/>
						</div>
						<div className="see-more-btn">
							<Link to="/ip-assets">
